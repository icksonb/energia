...
require_once(BASE_CLASS.DS.'dispositivos.php');
class dispositivosDAO extends database
{
	...
	public function select($fields="*",$add="",$params=null,$class=null)
	{
		...
		$sql = "SELECT $fields FROM DISPOSITIVOS $add";
	...
	public function insert($fields,$params=null)
	{
		...
		$sql = "INSERT INTO DISPOSITIVOS ($fields) VALUES ($numparams)";
	...
	public function update($fields,$params=null,$where=null){
		...
		$sql = "UPDATE DISPOSITIVOS SET $fields_T";
    ...
    public function count($var=null, $where=null){
		$sql = "SELECT COUNT($var) FROM DISPOSITIVOS";
		if(isset($where)) $sql .= " WHERE $where";
		$t=$this->selectDB($sql);
		return $t;
    }
