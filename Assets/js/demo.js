...
demo = {
    ...
    login: function()
    {
      ...
      jQuery.extend(jQuery.validator.messages, {
            ...
            minlength: jQuery.validator.format("Deve conter no mínimo {0} caracteres."),
    ...
    initWizard: function()
    {
        ...
        jQuery.extend(jQuery.validator.messages, {
            required: "Campo obrigatório",
            email: "Por favor, entre com um endereço de e-mail válido.",
            number: "Por favor, entre com um número.",
